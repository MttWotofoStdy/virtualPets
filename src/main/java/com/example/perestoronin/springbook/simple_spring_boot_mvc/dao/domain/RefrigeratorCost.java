...
public class RefrigeratorCost {
    ...
    public RefrigeratorCost(int id, Refrigerator refrigerator, BuildingMaterial buildingMaterial, int cost) {
        super();
        this.id = id;
    ...
    public String toString() {
        return "RefrigeratorCost [id= " + id + ", refrigerator= " + refrigerator  +
